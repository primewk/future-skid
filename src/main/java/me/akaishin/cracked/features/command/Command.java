package me.akaishin.cracked.features.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(Cracked.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            Cracked.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return Cracked.commandManager.getPrefix();
    }
