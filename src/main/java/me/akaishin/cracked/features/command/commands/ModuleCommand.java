...
import me.akaishin.cracked.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Cracked.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : Cracked.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Cracked.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Cracked.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
