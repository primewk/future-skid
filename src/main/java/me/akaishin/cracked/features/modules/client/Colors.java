...
public class Colors
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().colorSync.getValue().booleanValue()) {
            Cracked.colorCrackManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
        if (FutureGui.getInstance().colorSync.getValue().booleanValue()) {
            Cracked.colorFutureClient.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), FutureGui.getInstance().hoverAlpha.getValue());
        }
        if (GuiFuture.getInstance().colorSync.getValue().booleanValue()) {
            Cracked.colorManagerf.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), GuiFuture.getInstance().hoverAlpha.getValue());
        }
        if (FutureGuiB8.getInstance().colorSync.getValue().booleanValue()) {
            Cracked.colorExeterGuiManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), FutureGuiB8.getInstance().hoverAlpha.getValue());
        }
    }
