...
public class Notifications
        extends Module {
    private static final String fileName = "Cracked/util/ModuleMessage_List.txt";
        ...
        if (this.visualRange.getValue()) {
            ...
            if (tickPlayerList.size() > 0) {
                for (EntityPlayer player : tickPlayerList) {
                    ...
                    if (Cracked.friendManager.isFriend(player)) {
    ...
    public TextComponentString getNotifierOn(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
				case CRACKED: {
                    TextComponentString text = new TextComponentString((Cracked.commandManager.getClientMessage()) + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.GREEN + " enabled.");
                    return text;
                }
                case FUTURE: {
                ...
                case PHOBOS: {
                    final TextComponentString text = new TextComponentString(ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.GREEN + " enabled.");
                    return text;
                }
                case DOTGOD: {
        ...
        TextComponentString text = new TextComponentString(Cracked.commandManager.getClientMessage() + " " + ChatFormatting.GREEN + module.getDisplayName() + " toggled on.");
        return text;
    }
    ...
    public TextComponentString getNotifierOff(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
				case CRACKED: {
                    TextComponentString text = new TextComponentString((Cracked.commandManager.getClientMessage()) + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.RED + " disabled.");
                    return text;
                }
                case FUTURE: {
                ...
                case PHOBOS: {
                    final TextComponentString text = new TextComponentString(ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.RED + " disabled.");
                    return text;
                }
                case DOTGOD: {
        ...
        TextComponentString text = new TextComponentString(Cracked.commandManager.getClientMessage() + " " + ChatFormatting.RED + module.getDisplayName() + " toggled off.");
        return text;
    }
