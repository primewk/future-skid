...
import me.akaishin.cracked.event.events.ConnectionEvent;
...
public class LogoutSpots
    ...
    private final Setting<Integer> red = this.register(new Setting<Integer>("Red", 5, 0, 255));
    private final Setting<Integer> green = this.register(new Setting<Integer>("Green", 255, 0, 255));
    private final Setting<Integer> blue = this.register(new Setting<Integer>("Blue", 5, 0, 255));
