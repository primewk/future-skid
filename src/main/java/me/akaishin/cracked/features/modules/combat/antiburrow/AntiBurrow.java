package me.akaishin.cracked.features.modules.combat.antiburrow;
...
import me.akaishin.cracked.features.modules.combat.antiburrow.Utils.EntityUtil;
import me.akaishin.cracked.features.modules.combat.antiburrow.Utils.BlockUtil;
...
extends Module {
    ...
    private EntityPlayer getTarget(double d) {
        ...
        for (EntityPlayer entityPlayer2 : AntiBurrow.mc.world.playerEntities) {
            ...
            if (Cracked.speedManager.getPlayerSpeed(entityPlayer2) > 10.0) {
                continue;
            }
    ...
    public AntiBurrow() {
        super("AntiBurrow", "AntiBurrow Fuck You.", Module.Category.COMBAT, true, false, false);
    }
}
