...
public class Surround
    ...
    public void onEnable() {
        ...
        switch (this.centerType.getValue()) {
            case Instant: {
                Cracked.positionManager.setPositionPacket((double)this.startPos.getX() + 0.5, this.startPos.getY(), (double)this.startPos.getZ() + 0.5, true, true, true);
            }
            case Motion: {
                Cracked.movementManager.setMotion(((double)this.startPos.getX() + 0.5 - Surround.mc.player.posX) / 2.0, Surround.mc.player.motionY, ((double)this.startPos.getZ() + 0.5 - Surround.mc.player.posZ) / 2.0);
            }
		}
        this.retries.clear();
        ...
        for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1: {
                    ...
                    if (Cracked.speedManager.getSpeedKpH() != 0.0 || isExtending || this.extenders >= 1) continue block5;
