...
public class PingSpoof
    ...
    private final Setting<Integer> delay = this.register(new Setting<Object>("DelayMS", Integer.valueOf(100), Integer.valueOf(0), Integer.valueOf(27000), v -> this.seconds.getValue() == false));
