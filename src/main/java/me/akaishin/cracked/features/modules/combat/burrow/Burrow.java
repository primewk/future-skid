package me.akaishin.cracked.features.modules.combat.burrow;

import me.akaishin.cracked.features.modules.Module;
import me.akaishin.cracked.mixin.mixins.burrow.IMinecraft;
...
public class Burrow
        extends Module {
    public final Setting<BlockMode> mode = this.register(new Setting<BlockMode>("Block", BlockMode.Obsidian));
    public final Setting<Integer> offset = this.register(new Setting<Integer>("Offset", 7, 1, 20));
    ...
    public void onUpdate() {
        ...
        if (findHotbarBlock(mode.getValue().clazz) == -1) {
            Command.sendMessage("Can't find " + mode.getValue().clazz.getSimpleName().replaceFirst("Block", "") + " in hotbar!");
            disable();
            return;
        }
