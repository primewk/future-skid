...
public class ColorUtil {
    ...
    public static Color rainbow(int n) {
        ...
        return Color.getHSBColor((float)(d % 360.0 / 360.0), ShaderGlow.INSTANCE().rainbowSaturation.getValue() / 255.0f, ShaderGlow.INSTANCE().rainbowBrightness.getValue() / 255.0f);
    }
