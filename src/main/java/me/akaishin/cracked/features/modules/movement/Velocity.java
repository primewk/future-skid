...
import me.akaishin.cracked.event.EntityCollisionEvent;
import me.akaishin.cracked.event.events.PacketEvent;
import me.akaishin.cracked.event.events.PushEvent;
...
public class Velocity
    ...
    public Setting<Boolean> blocks = this.register(new Setting<Boolean>("Blocks", true));
    public Setting<Boolean> ice = this.register(new Setting<Boolean>("Ice", true));
