...
package me.akaishin.cracked.features.future.guifutureold.futuregui.components;
...
public class Component extends Feature {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final float totalItemHeight = this.open ? (this.getTotalItemHeight() - 2.0f) : 0.0f;
         int color = -7829368; //test
            //color = ColorUtil.toARGB(((Integer)(FutureGuiB8.getInstance()).red.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).green.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).blue.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).hoverAlpha.getValue()).intValue());
     
         ///Test drawGradientRect replace or drawRect 
         //RenderMethods.drawRect(this.x, (float)this.y - 1.5f, this.x + this.width, this.y + this.height - 6,color);
         //RenderMethods.drawGradientRect(this.x, (float)this.y - 1.5f, this.x + this.width, this.y + this.height - 6, ((Integer)(FutureGuiB8.getInstance()).red.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).green.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).blue.getValue()).intValue(), ((Integer)(FutureGuiB8.getInstance()).hoverAlpha.getValue()).intValue());//0x77FB4242, 0x77FB4242);
         RenderMethods.drawGradientRect(this.x, (float)this.y - 1.5f, this.x + this.width, this.y + this.height - 6, Cracked.colorExeterGuiManager.getColorWithAlpha(Cracked.moduleManager.getModuleByClass(FutureGuiB8.class).hoverAlpha.getValue()), Cracked.colorExeterGuiManager.getColorWithAlpha(Cracked.moduleManager.getModuleByClass(FutureGuiB8.class).hoverAlpha.getValue()));
         if (this.open) {
             ...
             Cracked.textManager.drawStringWithShadow(getName(), this.x + 3.0F, this.y - 4.0F - FutureGuiExeter.getFutureGuiOld().getTextOffset(), -1);
...
/*----------------------------------------------FutureArrow----------------------------------- */
    ...
    if (FutureGuiB8.getInstance().future.getValue()) {
...
/*--------------------------------------------------------------------------------------------- */
    ...
    public void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            FutureGuiExeter.getFutureGuiOld().getComponents().forEach(component -> {
                if (component.drag) {
