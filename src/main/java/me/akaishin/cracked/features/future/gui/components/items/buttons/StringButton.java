...
public class StringButton extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.isListening) {
            Cracked.textManager.drawStringWithShadow(this.currentString.getString() + Cracked.textManager.getIdleSign(), this.x + 2.3f, this.y - 1.7f - CrackedHackGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
        else {
            Cracked.textManager.drawStringWithShadow((this.setting.shouldRenderName() ? (this.setting.getName() + " \u00A77") : "") + this.setting.getValue(), this.x + 2.3f, this.y - 1.7f - CrackedHackGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
    }
