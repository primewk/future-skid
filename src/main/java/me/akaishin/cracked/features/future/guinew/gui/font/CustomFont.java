...
package me.akaishin.cracked.features.future.guinew.gui.font;
...
//import me.akaishin.cracked.features.modules.client.Media;
...
public class CustomFont extends CFont {
   ...
   public float drawString(String textIn, double xI, double yI, int color, boolean shadow) {
      ...
      double x = xI;
      double y = yI;
      if (me.akaishin.cracked.features.modules.client.FontMod.getInstance().isOn() && !(Boolean)me.akaishin.cracked.features.modules.client.FontMod.getInstance().shadow.getValue() && shadow) {
         x = xI - 0.5D;
         y = yI - 0.5D;
      }
